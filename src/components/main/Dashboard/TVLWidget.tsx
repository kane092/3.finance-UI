...
import { updatePathName } from 'store/actions/globalAction';
...
export default function TVLWidget() {
    ...
    useEffect(() => {
        ...
        fieldData.filter((field: FieldType) => {
            if ((field.type === "CompoundFields" || field.type === "OtherFields") && field.depositsLP  && field.depositsLP > 0) {
                depositedCount ++;
            }
        });
        ...
        <Grid className='tvl-widget mb-[30px] mr-[0px] md:mb-[0px] md:mr-[30px] w-[calc(100vw-40px)] md:w-[calc(33.33vw-78px)]'>
            <div className='tvl-widget-bg'>
                <div className='flex items-center px-[30px] pt-[30px]'>
                    <img loading="lazy" src={DashboardTVLImg} className='w-[22px] h-[25px] mr-[15px]' alt='' />
                    ...
                    <div className='overlay-content'>
                        ...
                        <Link to={'/deposits'}>
                            <div 
                                ...
                                <p className='font-lg text-[#00FFFF]'>Deposit</p>
                            </div>
                        </Link>
                    </div>
                </div>
