...
export default function PossibleLiqudityField({
  ...
  const assetSelected = useSelector(
    (state: RootState) => state.navbar.rightNavbarAssetSelected
  );
    ...
    if (subTabSelected === "Mint") {
      ...
      if (isSelected) {
        ...
        if (
          ...
          fieldSelected.signalSelected === "CRV wallet"
        )
          return 1;
        else return 0;
      }
  ...
  return (
    ...
    >
      <Grid
        xs={4}
        md={3}
        className="flex items-center justify-between py-[0px!important]"
      >
        ...
        {field.type === "OtherFields" && (
          <div className="xl:block mr-[10px] 2xl:mr-[10px] 3xl:mr-[10px] flex flex-col items-end">
            <img
              loading="lazy"
              alt=""
              src={field.wrapperSymbol}
      ...
      <Grid
        xs={4}
        md={4}
        className="Field-APR justify-start md:justify-between xl:justify-between"
      >
            ...
            {pageSelected === "Emissions" && field.name !== "CRV wallet" && (
              <>
                {walletConnected === "Disconnected" ? (
                  "T.C.E"
                ) : field.emissionLastSignalSymbol ? (
                  <img
                    loading="lazy"
                    src={field.emissionLastSignalSymbol}
        ...
        <div className="mr-[0px] md:mr-[10px] 2xl:mr-[40px] 3xl:mr-[50px] flex flex-col items-end">
          {pageSelected === "Deposits" && (
            <span className="duration-300">{field.depositsAPR}</span>
          )}
          ...
          {pageSelected === "Deposits" ? (
            ...
            <span className="Field-APR-Hover hidden md:flex text-[#C3D6E2] text-[12px] leading-[15px]">
              <NumberField
                value={
                  walletConnected === "Connected"
                    ? field.symbol === "CRVWallet"
        ...
        {pageSelected === "Deposits" && walletConnected === "Connected" && (
          <div
            className={classNames(
              ...
              indicatorFlag === 1
                ? "Deposits-Indicator-Left after:right-[calc(-56px+8.4vw)] 2xl:after:right-[-56px]"
                : "",
              indicatorFlag === 2
                ? "Deposits-Indicator-Right after:right-[calc(-64px+8.4vw)] 2xl:after:right-[-64px]"
                : "",
            ...
            <div className="hidden md:block">
              <div className="duration-300 flex flex-row items-center bg-[#d9d9d91a] py-[6px] pl-[10px] pr-[12px] rounded-[21px]">
                ...
                <span className="text-[10px] font-normal leading-[12px]">
                  DEPOSIT BALANCE TO GAIN 3.FINANCE BENEFITS AND PROTOCOL
                  UTILITY.
                </span>
              </div>
            </div>
          ...
          <>
            ...
            <div
              className={classNames(
                ...
                indicatorFlag === 0
                  ? "px-[0px] xl:px-[10px] 2xl:px-[40px] 3xl:px-[50px]"
                  : "px-[0px] 2xl:px-[40px] 3xl:px-[50px]",
                indicatorFlag === 1 && pageSelected === "Deposits"
                  ? "Deposits-Indicator-Left after:right-[calc(-56px+8.4vw)] 2xl:after:right-[-56px]"
                  : "",
                indicatorFlag === 1 && pageSelected === "Emissions"
                  ? "Emissions-Indicator-Left after:right-[calc(-56px+8.4vw)] 2xl:after:right-[-56px]"
                  : "",
                indicatorFlag === 2 && pageSelected === "Deposits"
                  ? "Deposits-Indicator-Right after:right-[calc(-56px+8.4vw)] 2xl:after:right-[-56px]"
                  : "",
                indicatorFlag === 2 && pageSelected === "Emissions"
                  ? "Emissions-Indicator-Right after:right-[calc(-56px+8.4vw)] 2xl:after:right-[-56px]"
                  : "",
                navbarIndicatorFlag ? "Indicator-Animation" : ""
              )}
            >
            ...
            <div
              className={classNames(
                ...
                indicatorFlag === 0
                  ...
                  : "px-[0px] 2xl:px-[40px] 3xl:px-[50px]",
                indicatorFlag === 1
                  ? "Emissions-Indicator-Left after:right-[calc(-48px+8.4vw)] xl:after:right-[-48px]"
                  : "",
                indicatorFlag === 2
                  ? "Emissions-Indicator-Right after:right-[calc(-56px+8.4vw)] xl:after:right-[-56px]"
                  : "",
                navbarIndicatorFlag ? "Indicator-Animation" : ""
              )}
            >
