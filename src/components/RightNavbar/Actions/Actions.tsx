    ...
    <>
      ...
      >
        <div className='RightNavbar-Content-Left'>
          ...
          {subTabSelected === "Withdraw" && <Withdraw />}
          ...
          {inputWithPercentageShow && subTabSelected !== "Deposit" && <InputWithPercentage adornmentText={assetSelected === "None" && fieldSelected.type !== '3FiCollateral' ? "No asset selected" : fieldSelected.type === '3FiCollateral' ? selectedAssetName + ' to ' + inputPlaceHolder : assetSelected} validationText={getValidationText()} />}

          {(walletConnected === "Connected" || subTabSelected === "Merge" || subTabSelected === 'BurnNFT') && subTabSelected !== "Deposit" && fieldSelected.name !== "" &&
            <ActionSummary subTab={subTabSelected} actionsButtonShow={actionsButtonShow} />}
        </div>
