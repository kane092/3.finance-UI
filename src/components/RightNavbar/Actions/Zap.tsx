  ...
  return (
    <>
      ...
      <div className='w-full'>
        ...
        <p className='mb-[10px] text-right'>...convert to {fieldSelected.type === "CompoundFields" ? 3 : ''}{fieldSelected.tokens && fieldSelected.tokens[1]}</p>
        ...
        <div className='flex justify-between mb-[10px]'>
          ...
          <div className='text-[12px] text-right flex justify-end'>
            {
              direction[0] === true ?
              `1 ${fieldSelected.symbol} = 1.00 FRAX` :
              `1.00 FRAX = 1 ${fieldSelected.symbol}`
            }
            <img loading="lazy" 
              src={NavbarExchange} 
          ...
          <div className='text-[12px] text-right flex justify-end'>
            {
              direction[0] === true ?
              `1 ${assetSelected} = 2,000.00 ${fieldSelected.symbol}` :
              `2,000.00 ${fieldSelected.symbol} = 1 ${assetSelected}`
            }
            <img loading="lazy" 
              src={NavbarExchange} 
              className="exchange-icon" 
