  ...
  return (
    <>
      <p className='RightNavbar-SubTab-Content'>
        Use the ‘Distribute feature to top-up regularly used Money Apps with a single click.<br />Note: Any unallocated collateral will be returned to the Curve C.D.P for further compounding.
      </p>
          ...
          <div className='flex justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col items-center mr-[10px] cursor-pointer'>
                ...
                {assetSelected === 'CRV' &&
                <img loading="lazy" src={NavbarEmissionPointer} alt='' className='mt-[5px]' />}
              </div>
              <div className='flex flex-col items-center mr-[10px] cursor-pointer'>
                <p 
