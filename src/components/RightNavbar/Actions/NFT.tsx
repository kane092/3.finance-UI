    ...
    <div className='flex flex-col cursor-pointer' onClick={() => {
      ...
      <img loading="lazy"
        ...
        className={classNames(
          'w-[40px] md:w-[30px] xl:w-[35px] 2xl:w-[40px] h-[40px] md:h-[30px] xl:h-[35px] 2xl:h-[40px] nft',
      ...
      <div className='flex justify-center'>
        {status !== 0 &&
          ...
          <img loading="lazy" alt='' src={availability !== 0 ? (availability === 1 ? NavbarGreenDot : NavbarWhiteDot) : NavbarRedDot} className='w-[2px] h-[2px] text-center mt-[5px]' />
        }
        {status === 0 &&
          <img loading="lazy" alt='' src='' className='w-[2px] h-[2px] text-center mt-[5px]' />
        }
      </div>
      <span
        className={
