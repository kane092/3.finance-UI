...
export default function NFTs() {
  ...
  return (
    <>
      <p className='RightNavbar-SubTab-Content mb-[20px]'>Use 3Fi tokens and Curve C.D.P L.P positions to mint 3Fi NFTs. 3Fi NFTs simplify harvest activity, gain access to communal harvest incentives and receive a share of protocol revenue.</p>
