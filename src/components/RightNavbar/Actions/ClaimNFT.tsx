...
export default function ClaimNFT() {
  ...
  return (
    <>
      <p className='RightNavbar-SubTab-Content'>Claim unallocated CRV in stables (FRAX).<br />If stables are desirable, it is recommended to claim unallocated CRV before distributing.</p>
      <div className='w-full'>
        ...
        <div className='flex items-center text-left bg-[#D9D9D9]/[0.1] px-[15px] py-[12px] rounded-[20px]'>
          <img loading="lazy" src={QuestionIcon} className="w-[13px] h-[13px] mr-[8px]" alt='' />
          <span className='text-left text-[8px] leading-[10px] uppercase tracking-widest'>
            Only available when 3Fi tokens oR NFT’s have been accrued or purchased
          </span>
        </div> :
        <div className=''>
          ...
          <>
            ...
            <div className='flex justify-between mb-[10px]'>
              ...
              <p className='flex'>
                ...
                <img loading="lazy" src={NavbarExchange} className='exchange-icon' onClick={() => updateDirection(0)} />
              </p>
            </div>
            <div className='flex justify-end'>
              <p className='flex'>
                ...
                <img loading="lazy" src={NavbarExchange} className='exchange-icon' onClick={() => updateDirection(1)} />
              </p>
            </div>
            <hr className='my-[11px]' />
