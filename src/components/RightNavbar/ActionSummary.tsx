    ...
    <div className={actionsButtonShow ? 'text-[14px] pb-[160px] 2xl:pb-[188px]' : 'text-[14px]'}>
      ...
      <>
        ...
        <div 
          ...
          <img loading="lazy" alt='' src={ArrowRight} className="ml-[5px]" />
        </div>}
        {(!bentTVL) &&
        <div 
          className='flex justify-end items-center mb-[10px] text-[#00FFFF] cursor-pointer'
      ...
      <>
        ...
        <p className='text-right text-[#C3D6E2] mb-[10px]'>Convert {assetSelected} to {fieldSelected.type === "CompoundFields" ? 3 : ''}{fieldSelected.tokens[1]} LP tokens.<br /><br />Waiting for amount to complete summary.</p> :
        <></>}
        {(maxValue && assetSelected !== "None" && curValue > maxValue) ?
        <>
          <p className='text-right text-[#C3D6E2] mb-[10px]'>Convert {assetSelected} to {fieldSelected.type === "CompoundFields" ? 3 : ''}{fieldSelected.tokens[1]} LP tokens.<br /></p>
          <p className='text-right text-red-600 mb-[10px]'>Please resolve the error before continuing.</p>
        </> :
        <></>}
        {(maxValue && assetSelected !== "None" && curValue <= maxValue && curValue > 0) ?
        <p className='text-right text-[#C3D6E2] mb-[10px]'>Convert <NumberField value={curValue} digit={2} /> {assetSelected}<br /><br />to Est. <NumberField value={curValue * 2000} digit={2} /> {fieldSelected.type === "CompoundFields" ? 3 : ''}{fieldSelected.tokens[1]} LP tokens.</p> :
        <></>}
        {!maxValue &&
      ...
      <>
        ...
        <p className='text-right text-[#C3D6E2] mb-[10px]'>Withdraw {<NumberField value={curValue} digit={2} />} {assetSelected} to connected wallet.</p> :
        <></>}
        {!maxValue &&
        <a href='/' className='flex justify-end items-center mb-[10px] text-[#00FFFF]'>
      ...
      <>
        ...
        <p className='text-right text-[#C3D6E2] mb-[10px]'>Harvest accrued {fieldSelected.tokens[0]} emissions.<br /><br />Deposit into {fieldSelected.signalSelected} C.D.P.</p>}
