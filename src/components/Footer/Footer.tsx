    ...
    <div className="fixed bottom-[0px] bg-[url('./assets/images/footer.png')] w-full pt-[50px] pb-[30px] pl-[40px]">
      <div className='flex justify-between mb-[20px]'>
        <p className='flex items-center w-full text-[24px] leading-[31px] font-medium'>
          <img loading="lazy" src={FooterLogo} alt='' className='mr-[5px]' />
          Finance
        </p>
        <a href='/'>
          <p className='flex items-center mr-[200px] text-[14px] leading-[21px] text-[#00FFFF]'>
            Audit
            <img loading="lazy" src={ArrowRight} alt='' className='ml-[5px]' />
          </p>
        </a>
        <img loading="lazy" src={ArrowUp} alt='' className='w-[19px] h-[22px] mr-[25px]' />
      </div>
      <div className='pr-[70px] pl-[30px]'>
        ...
        <div>
          ...
          <div className='flex'>
            <a href='/'>
              <img loading="lazy" src={FooterTwitter} alt='' className='mr-[10px]' />
            </a>
            <a href='/'>
              <img loading="lazy" src={FooterDiscord} alt='' className='mr-[10px]' />
            </a>
            <a href='/'>
              <img loading="lazy" src={FooterTelegram} alt='' className='mr-[10px]' />
            </a>
            <a href='/'>
              <img loading="lazy" src={FooterMedium} alt='' className='mr-[10px]' />
            </a>
          </div>
        </div>
        ...
        <div className='flex justify-between items-end'>
          ...
          <div className='mr-[30px]'>
            ...
            <img loading="lazy" src={AuditedBy} alt='' />
          </div>
          <img loading="lazy" src={Zokyo} alt='' />
        </div>
      </div>
    </div>
  )
