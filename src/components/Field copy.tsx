...
export default function Field({ field, fieldFlag, firstField }: props) {
  ...
  const isNFT =
    field.depositsFullName && field.depositsFullName.includes("3Fi NFTs");
  ...
  return (
    <Grid
      ...
      className={classNames(
        ...
        isNFT && !field.depositsLP ? "Field-Hidden" : "",
    ...
    >
        ...
        <div className="mr-[0px] md:mr-[10px] 2xl:mr-[40px] 3xl:mr-[50px] flex flex-col items-end">
          {pageSelected === "Deposits" && (
            <span className="text-transition">
              <NumberField value={field.depositsAPR} digit={2} />
            </span>
          )}
      ...
      <Grid
        ...
        md={5}
        className={`${
          pageSelected === "Deposits" ? "" : "multi-line"
        } Field-TVL justify-start md:justify-end xl:justify-between`}
      >
        <div
          id={field.symbol + "-indicator"}
          className={classNames(
            ...
            indicatorFlag === 2 &&
              pageSelected === "Emissions" &&
              tabSelected === "Actions"
              ? "Emissions-Indicator-Right after:right-[calc(-64px+8.4vw)] 2xl:after:right-[-64px]"
              : "",
        ...
        <div
          className={classNames(
            ...
            needBackwordAnimation === 0
              ? ""
              : needBackwordAnimation === 1
              ? "backword-animation-left after:right-[calc(-56px+8.4vw)] 2xl:after:right-[-56px]"
              : "backword-animation-right after:right-[calc(-64px+8.4vw)] 2xl:after:right-[-64px]"
          )}
        >
          {pageSelected === "Emissions" && (
            <span className="text-transition">
              <NumberField
                value={field.symbol === "CRVWallet" ? 0 : field.emissionsAPR}
                digit={2}
              />
              &nbsp;%
            </span>
          ...
          {pageSelected === "Emissions" && (
            <span className="Field-APR-Hover hidden md:flex text-[#C3D6E2] text-[12px] leading-[15px] text-transition">
              +{" "}
              <NumberField
                value={field.symbol === "CRVWallet" ? 100 : 16.34}
                digit={2}
              />{" "}
              %
            </span>
